...
public class QuadProbeHashTableTest {
	...
	public void testQuadProbeHashTable() {
		QuadProbeHashTable table = new QuadProbeHashTable(10, new GoodHashFunctor());
	...
	public void testAddAll() {
		...
		stringList.add("jay");
		stringList.add("may");
		QuadProbeHashTable table = new QuadProbeHashTable(4, new GoodHashFunctor());
		assertTrue(table.addAll(stringList));

		// Test if there is duplicate in the stringList, will the addAll method
		// add the duplicate?
		...
		QuadProbeHashTable table2 = new QuadProbeHashTable(4, new GoodHashFunctor());
		...
		// Test if nothing in the table, will the table still can call the
		// addAll method
		QuadProbeHashTable table3 = new QuadProbeHashTable(4, new GoodHashFunctor());
